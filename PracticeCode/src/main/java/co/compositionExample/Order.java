package co.compositionExample;

import java.util.ArrayList;
import java.util.List;


//This is the Order class, which HAS-A composition association with LineItem class. That means if you delete Order, then associated all LineItem must be deleted.
class Order {
    private int id;
    private String name;
